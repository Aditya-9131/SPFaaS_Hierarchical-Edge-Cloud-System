...
void assign_parents( vector<computation_spot*>&all_cs){
    all_cs[0]->par=all_cs[8];
    all_cs[1]->par=all_cs[8];
    all_cs[2]->par=all_cs[9];
    all_cs[3]->par=all_cs[9];
    all_cs[4]->par=all_cs[10];
    all_cs[5]->par=all_cs[10];
    all_cs[6]->par=all_cs[11];
    all_cs[7]->par=all_cs[11];
    all_cs[8]->par=all_cs[12];
    all_cs[9]->par=all_cs[12];
    all_cs[10]->par=all_cs[13];
    all_cs[11]->par=all_cs[13];
    
    //---------------------------------------------------------------//
    all_cs[8]->left_child=all_cs[0];
    all_cs[8]->right_child=all_cs[1];
    all_cs[9]->left_child=all_cs[2];
    all_cs[9]->right_child=all_cs[3];
    all_cs[10]->left_child=all_cs[4];
    all_cs[10]->right_child=all_cs[5];
    all_cs[11]->left_child=all_cs[6];
    all_cs[11]->right_child=all_cs[7];
    all_cs[12]->left_child=all_cs[8];
    all_cs[12]->right_child=all_cs[9];
    all_cs[13]->left_child=all_cs[10];
    all_cs[13]->right_child=all_cs[11];
}
