...
mapping_dict = {
    'country': {'ca': 0, 'global': 1, 'de': 2, 'jp': 3, 'in': 4, 'us': 5, 'mx': 6, 'se': 7,'tr':8,'co':9,'hu':10,'hk':11,'fi':12,'eg':13,'br':14,'ph':15}
}
...
selected_columns['deadline'] = selected_columns['duration'] % 1000 #defining the deadline
#
